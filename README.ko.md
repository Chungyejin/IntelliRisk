...
| 이름 | 역할 | 담당 업무  |
| :--- | :--- | :--- |
| **Yejin Chung** | **Backend Engineer** | • Flask 기반 REST API 서버 설계 및 구현<br>• 온습도 데이터 수신 및 뎅기열 위험도 연산 알고리즘 개발<br> • Backend API 연동을 통한 실시간 데이터 업데이트|
...
| **Michele Cristibna Otta** | **Frontend Engineer** |• 웹 모니터링 대시보드 UI/UX 설계 및 개발<br>• 지역별 온습도 추이 및 뎅기열 위험도 통계 시각화 화면 구현<br> |
